...
class CITTestiImportHandler extends SQLIImportAbstractHandler implements ISQLIImportHandler
{
    ...
    {        
        ...
        $contentOptions = new SQLIContentOptions( array(
            'class_identifier'      => 'testo_generico',
            'remote_id'				=> $remote_id,
            'language'              => 'ita-IT'
        ) );
		...
		$content->fields->indirizzo = trim( $row->address );
		...
		$content->fields['eng-GB']->indirizzo = trim( $row->address );
        ...
        $content->fields['ger-DE']->indirizzo = trim( $row->address );
